 ...
 */
class ZgwToVrijbrpUittrekselActionHandler implements ActionHandlerInterface
{
    /**
     * @var UittrekselService The UittrekselService that will handle code for this Handler.
     */
    private UittrekselService $uittrekselService;

    /**
     * Construct a ZgwToVrijbrpUittrekselHandler.
     *
     * @param UittrekselService $uittrekselService The UittrekselService that will handle code for this Handler.
     */
    ...
    public function getConfiguration(): array
    {
        return [
            ...
            'title'       => 'ZgwToVrijbrpUittrekselActionHandler',
    ...
    {
        return $this->uittrekselService->zgwToVrijbrpHandler($data, $configuration);
    }//end run()
}